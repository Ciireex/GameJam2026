...
public class ShutDownReactor : MonoBehaviour
{
    ...
    [Tooltip("Si tus luces tienen scripts tipo EmergencyLight que cambian la intensidad, arr�stralos aqu� para desactivarlos al apagar.")]
    ...
    [Tooltip("�ndice de la escena del Main Menu en Build Settings.")]
    [SerializeField] private int mainMenuSceneIndex = 0;

    [Tooltip("Usar transici�n del SceneController (si existe).")]
    ...
    private IEnumerator ShutdownSequence()
    {
        ...
        // Congelar player + invulnerable + m�scara off (sin acoplar)
        ...
        if (reactorLights != null)
        {
            for (int i = 0; i < reactorLights.Length; i++)
            {
                ...
                // Eliminar luz (m�s seguro que Destroy inmediato)
